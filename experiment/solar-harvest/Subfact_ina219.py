...
import time
import smbus
from Adafruit_I2C_Edison import Adafruit_I2C
...
# ===========================================================================
	...
	def ina219SetCalibration_16V_400mA(self):
		self.ina219_currentDivider_mA = 20  # Current LSB = 100uA per bit (1000/100 = 10)
	...
	def getCurrent_mA(self):
		...
		valueDec /= 1.0 * self.ina219_currentDivider_mA
		return valueDec
